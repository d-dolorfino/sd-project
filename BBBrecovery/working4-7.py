'''
Code based on the `working4-2_2pm.py` code. Slight changes will be done to the code.

This is the code use last night (4/8). No modifications from Abichar made.
'''
...
bus.write_byte_data(0x20, 0x7D, 0x04) # Mode control; enable PLL
