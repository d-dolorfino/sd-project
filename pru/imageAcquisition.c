...
#define D0 (0 << 0)         // P8_45: 0x0 at R31
#define D1 (1 << 0)         // P8_46: 0x1 at R31
#define D2 (1 << 1)         // P8_43: 0x2 at R31
#define D3 (1 << 2)         // P8_44: 0x3 at R31
#define D4 (1 << 3)         // P8_41: 0x4 at R31
...
void main(void) {
    ...
    while (1) {
        ...
        // Save pixel in RAM to be used by BBB
